...
# 總拼圖高, 總拼圖寬, 拼圖放置情形, 所有拼圖資訊, 總共有多少拼圖, 目前放了幾塊拼圖
...
def enter_puzzle():
    ...
    for i in range(num_of_puzzle):
        ...
        puzzles.append([puzzle['p_h'], puzzle['p_w'], puzzle['puzzle_pieces'], 0, 0])

    # print(puzzle_hash)
    # print(puzzles)
    return h, w, puzzle_hash, puzzles



if __name__ == '__main__':
    h, w, puzzle_hash, puzzles = enter_puzzle()
